...
const updateSemesterRegistrationIntoDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const currentRequesteSemesterStatus = isSemesterRegistrationExists === null || isSemesterRegistrationExists === void 0 ? void 0 : isSemesterRegistrationExists.status;
    if (currentRequesteSemesterStatus === 'ENDED') {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, `This semester is already ${currentRequesteSemesterStatus}`);
    }
    //UPCOMING ---> ONGOING---> ENDED
    if (currentRequesteSemesterStatus === semesterRegistration_constant_1.RegistrationStatus.UPCOMING &&
        requestedStatus === semesterRegistration_constant_1.RegistrationStatus.ENDED) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, `You can not directly change status from ${currentRequesteSemesterStatus} to ${requestedStatus}`);
    }
    if (currentRequesteSemesterStatus === semesterRegistration_constant_1.RegistrationStatus.ONGOING &&
