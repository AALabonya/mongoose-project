...
const updateSemesterRegistrationIntoDB = async (
  ...
  if (currentRequesteSemesterStatus === 'ENDED') {
    throw new AppError(
      httpStatus.BAD_REQUEST,
      `This semester is already ${currentRequesteSemesterStatus}`,
    );
  }

  //UPCOMING ---> ONGOING---> ENDED
  if (
    currentRequesteSemesterStatus === RegistrationStatus.UPCOMING &&
  ...
  if (
    currentRequesteSemesterStatus === RegistrationStatus.ONGOING &&
